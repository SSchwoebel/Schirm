...
void setup() {
  ...
  for (int i=0;i<LengthFFTBins ; i++)
  {
    ...
    FFTBinsXk[i]= i*SAMPLES/double(LengthFFTBins);
  }
...
SimplePatternList gPatterns = { OceanColors_FFT,RainbowColors_FFT,RainbowColors_fade};
